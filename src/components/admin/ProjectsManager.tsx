...
interface MappedProject extends Omit<Project, 'tags'> { // Omit original tags if it was string[] | null
  tags: string[] | null; // Keep this as array for display
  ...
  const fetchProjects = async () => {
    ...
    if (fetchError) {
      ...
      const mappedData: MappedProject[] = data.map(p => ({
        ...
        tags: p.tags, // already an array or null from DB
